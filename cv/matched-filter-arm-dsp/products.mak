...
DSP_SUPPORT = /data/dsp-support/
BOARD_SUPPORT = /data/board-support/

# Set this to your CE installation dir
CE_INSTALL_DIR = $(DSP_SUPPORT)/codec_engine_3_23_00_07/

#PROFILE = debug
PROFILE = debug 

# Define the product variables for the device you will be using.
#IPC_INSTALL_DIR         = $(DSP_SUPPORT)/ipc_1_25_01_09
FC_INSTALL_DIR          = $(CE_INSTALL_DIR)/cetools
#FC_INSTALL_DIR          = $(DSP_SUPPORT)/framework_components_3_31_00_02
LINK_INSTALL_DIR        = $(DSP_SUPPORT)/syslink_2_21_00_03
OSAL_INSTALL_DIR        = $(CE_INSTALL_DIR)/cetools
#OSAL_INSTALL_DIR        = $(DSP_SUPPORT)/osal_1_24_00_09
XDAIS_INSTALL_DIR       = $(CE_INSTALL_DIR)/cetools/
#XDAIS_INSTALL_DIR       = $(DSP_SUPPORT)/xdais_7_24_00_04
CMEM_INSTALL_DIR        = $(DSP_SUPPORT)/linuxutils_3_23_00_01
EDMA3_LLD_INSTALL_DIR   = $(CE_INSTALL_DIR)/cetools
#EDMA3_LLD_INSTALL_DIR   = $(DSP_SUPPORT)/edma3_lld_02_12_00_20
XDC_INSTALL_DIR         = $(DSP_SUPPORT)/xdctools_3_24_05_48
BIOS_INSTALL_DIR        = $(DSP_SUPPORT)/bios_6_34_03_19
DSPLIB_INSTALL_DIR      = $(DSP_SUPPORT)/dsplib_3_4_0_0

# Set location of various cgtools
ti.targets.C64P =
ti.targets.C674 =

ti.targets.elf.C64P = $(DSP_SUPPORT)/cgt6x_7_3_1/
ti.targets.elf.C64T =
ti.targets.elf.C66 =
ti.targets.elf.C674 =
...
#
#  @(#) codec_engine_3_23_00_07; 1, 0, 0,1; 8-14-2012 13:11:59; /db/atree/library/trees/ce/ce-u07/src/ xlibrary
