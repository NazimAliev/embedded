# xdc file is case sensitive! led != LED
...
set_property IOSTANDARD LVTTL [get_ports btnr]
set_property IOSTANDARD LVTTL [get_ports btnd]
...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets OV7670_HREF_IBUF]
